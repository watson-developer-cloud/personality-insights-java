...
var i18nTranslatorFactory = (function () { 
   ...
   */
  self.getKey = function (dictionary, key, defaultValue) {
    var parts = key.split('.');
...
var i18nProvider = (function(locale) { 
  ...
  /**
   * Sets the locale.
   * @param locale A locale (format: ll-CC or ll_CC).
   */
